...
class TestParsing(BaseTestCase):
    ...
    def test_parse_nan(self):
        self.assertEqual(parse_nan('nan'), (False, False, None))
        self.assertEqual(parse_nan('+nan'), (False, False, None))
        self.assertEqual(parse_nan('-nan'), (True, False, None))
        self.assertEqual(parse_nan('snan'), (False, True, None))
        self.assertEqual(parse_nan('-snan'), (True, True, None))
